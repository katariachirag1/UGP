...
urlpatterns = [
    ...
    url(r'^course/discussions/(?P<course_name>[\w\-]*)',course_views.discussions),
    url(r'^course/(?P<course_name>[\w\-]*)/comments',course_views.forum),
    url(r'^course/(?P<course_name>[\w\-]*)/forum',course_views.forum),
